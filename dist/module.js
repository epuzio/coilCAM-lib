...
// Helper Functions
function $df7b7fea591ea777$var$padValues(value, nbPoints, mode) {
...
function $df7b7fea591ea777$var$setValues(value, nbPoints, mode) {
    if (!value) return $df7b7fea591ea777$var$padValues([], nbPoints, mode);
    ...
    } else if (value.length < nbPoints) return $df7b7fea591ea777$var$padValues(value, nbPoints, mode);
    else if (value.length > nbPoints) return value.slice(0, nbPoints);
    return value;
}
function $df7b7fea591ea777$var$setOffset(value, nbPoints) {
...
function $df7b7fea591ea777$export$c3c5e174940bbb4f(functionType, offset, values0, nbPoints, mode) {
    offset = $df7b7fea591ea777$var$setOffset(offset, nbPoints);
    values0 = $df7b7fea591ea777$var$setValues(values0, nbPoints, mode);
...
function $df7b7fea591ea777$export$d49ab658f2d8f01e(functionType, offset0x, offset0y, values0x, values0y, nbPoints, mode) {
    offset0x = $df7b7fea591ea777$var$setOffset(offset0x, nbPoints);
    offset0y = $df7b7fea591ea777$var$setOffset(offset0y, nbPoints);
    values0x = $df7b7fea591ea777$var$setValues(values0x, nbPoints, mode);
    values0y = $df7b7fea591ea777$var$setValues(values0y, nbPoints, mode);
...
function $171d16fda35ebcb0$export$6a5b418875592792(path, layerHeight, nozzleDiameter, printSpeed) {
    if (Array.isArray(path) && path.length > 0) {
        ...
        for(var i = 0; i < path.length; i++){
            let x = $171d16fda35ebcb0$var$round2pt(path[i].x);
